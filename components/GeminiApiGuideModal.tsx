    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 z-[60] flex justify-center items-center p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-6 w-full max-w-3xl transform transition-all relative max-h-[90vh] flex flex-col">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none flex-grow overflow-y-auto pr-4 -mr-4">
            ...
            <h4>1단계: Google AI Studio 접속 및 로그인</h4>
            <ol>
            ...
            <ol>
                ...
                <li>'Create API key in new project' 또는 'Create API key in existing project' 옵션이 나타납니다. 처음이라면 <strong>[Create API key in new project]</strong>를 선택하는 것이 좋습니다.</li>
                <li>잠시 기다리면 API 키가 생성됩니다.</li>
            </ol>

            <h4>3단계: API 키 복사</h4>
            <ol>
                <li>API 키 목록에서 방금 생성된 키 (긴 글자와 숫자 조합)를 찾습니다.</li>
                <li>키 옆에 있는 복사 아이콘을 클릭하여 클립보드에 복사합니다.</li>
            </ol>
            
            <h4>4단계: 앱에 API 키 등록</h4>
            <ol>
