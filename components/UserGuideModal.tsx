    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 z-[60] flex justify-center items-center p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-6 w-full max-w-3xl transform transition-all relative max-h-[90vh] flex flex-col">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none flex-grow overflow-y-auto pr-4 -mr-4">
            ...
            <ul>
                <li>
                    <strong>AI 기능 (Gemini API 필요):</strong>
                    <br/>
                    <small>※ 이 기능들은 설정에서 'AI 변환 기능 사용'을 켜고 Gemini API 키를 등록해야 합니다. 사용량에 따라 Google로부터 비용이 청구될 수 있습니다.</small>
                    <ul className="list-disc pl-5 mt-2">
                        <li>
                            <strong>AI 변환 (탭):</strong> 'AI 변환' 탭에서 '아래아 한글(HWP)' 등에서 복사한 텍스트나 책을 찍은 이미지를 앱의 데이터 형식으로 한 번에 대량 변환합니다. 변환 결과를 미리보고 수정하여 앱에 추가하거나 엑셀로 다운로드할 수 있습니다.
                        </li>
                        <li>
                            <strong>이미지 텍스트 추출 (자료 추가 시):</strong> '키워드', '성경', '설교' 모드에서 자료를 추가하거나 수정할 때, <strong>'이미지에서 텍스트 추출'</strong> 기능을 사용할 수 있습니다. 책 페이지를 사진으로 찍거나 스크린샷을 첨부하면, AI가 이미지 속 텍스트를 인식하여 내용 입력창에 자동으로 채워줍니다.
                        </li>
                    </ul>
                </li>
                 <li>
